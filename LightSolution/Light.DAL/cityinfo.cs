	...
	
{
		...
		public partial class cityinfo
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from cityinfo");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into cityinfo(");			
            strSql.Append("id,regionid,cityname,creatman,creattime,remark");
			...
			MySqlParameter[] parameters = {
			            new MySqlParameter("@id", MySqlDbType.Int32,10) ,            
                        new MySqlParameter("@regionid", MySqlDbType.Int32,10) ,            
                        new MySqlParameter("@cityname", MySqlDbType.VarChar,10) ,            
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update cityinfo set ");
...
MySqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from cityinfo ");
			strSql.Append(" where id=@id ");
						MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32,10)			};
			parameters[0].Value = id;
		...
		public Light.Model.cityinfo GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, regionid, cityname, creatman, creattime, remark  ");			
			strSql.Append("  from cityinfo ");
			strSql.Append(" where id=@id ");
						MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32,10)			};
			parameters[0].Value = id;
			...
			Light.Model.cityinfo model=new Light.Model.cityinfo();
